# 🚀 SundaNow - Integrasi Google Sheets sebagai CMS

**Gunakan Google Sheets sebagai database artikel untuk website SundaNow. Generator otomatis membuat HTML dan memperbarui konten dengan mudah!**
...
# 1. Buat project (misal: "sunda-now-News")
